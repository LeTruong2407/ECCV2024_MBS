...
class Segmenter(nn.Module):
    ...
    def forward(self, im, ret_intermediate=False, classifiers=None):
        ...
        masks = self.decoder(x, (H, W), classifiers=classifiers)
        self.masks = masks
        ...
        if ret_intermediate:
            return masks, {'pre_logits': x}  # Return features before decoder
